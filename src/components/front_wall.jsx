    ...
    <div className="frontWallContainer">
      <div
        className={classNames("frontWallContainer__leftUpCorner", {
          ...
          clickNone_front: mainTab[5].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__middleUp", {
          ...
          clickNone_front: mainTab[12].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__rightUpCorner", {
          ...
          clickNone_front: mainTab[17].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__leftCenterCorner", {
          ...
          clickNone_front: mainTab[6].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__middleCenterUp", {
          ...
          clickNone_front: mainTab[13].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__rightCenterorner", {
          ...
          clickNone_front: mainTab[20].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__leftDownCorner", {
          ...
          clickNone_front: mainTab[7].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__middleDown", {
          ...
          clickNone_front: mainTab[14].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
      ...
      <div
        className={classNames("frontWallContainer__rightDownCorner", {
          ...
          clickNone_front: mainTab[23].sign !== "" || wallEndGame[3].end || (actualWall !=='FrontWall' && actualWall !=='Free'),
        })}
